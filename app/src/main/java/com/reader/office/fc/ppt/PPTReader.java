 ...
 * 时间:               下午4:23:51
 */
package com.reader.office.fc.ppt;
...
import com.reader.office.common.shape.ArbitraryPolygonShape;
...
import com.reader.office.common.shape.LineShape;
import com.reader.office.common.shape.PictureShape;
import com.reader.office.common.shape.ShapeTypes;
import com.reader.office.common.shape.TableCell;
import com.reader.office.common.shape.TableShape;
import com.reader.office.common.shape.TextBox;
import com.reader.office.constant.AutoShapeConstant;
...
import com.reader.office.fc.hslf.HSLFSlideShow;
import com.reader.office.fc.hslf.model.Fill;
import com.reader.office.fc.hslf.model.HeadersFooters;
import com.reader.office.fc.hslf.model.Line;
import com.reader.office.fc.hslf.model.MasterSheet;
import com.reader.office.fc.hslf.model.Notes;
import com.reader.office.fc.hslf.model.Shape;
import com.reader.office.fc.hslf.model.ShapeGroup;
import com.reader.office.fc.hslf.model.Sheet;
import com.reader.office.fc.hslf.model.SimpleShape;
import com.reader.office.fc.hslf.model.Slide;
import com.reader.office.fc.hslf.model.SlideMaster;
import com.reader.office.fc.hslf.model.TextShape;
import com.reader.office.fc.hslf.model.TitleMaster;
...
import com.reader.office.fc.hslf.record.Record;
...
import com.reader.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.reader.office.fc.hslf.usermodel.PictureData;
import com.reader.office.fc.hslf.usermodel.RichTextRun;
import com.reader.office.fc.hslf.usermodel.SlideShow;
import com.reader.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.reader.office.fc.ss.usermodel.Textbox;
import com.reader.office.java.awt.Dimension;
import com.reader.office.java.awt.Rectangle;
import com.reader.office.java.awt.Rectanglef;
import com.reader.office.java.awt.geom.Rectangle2D;
import com.reader.office.pg.animate.ShapeAnimation;
import com.reader.office.pg.model.PGModel;
import com.reader.office.pg.model.PGNotes;
import com.reader.office.pg.model.PGSlide;
...
import com.reader.office.ss.util.format.NumericFormatter;
import com.reader.office.system.AbstractReader;
import com.reader.office.system.BackReaderThread;
...
{   
    ...
    private com.reader.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.reader.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.reader.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.reader.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.reader.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.reader.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.reader.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.reader.office.fc.hslf.model.AutoShape  // 文本框 
                    || shape instanceof com.reader.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.reader.office.fc.hslf.model.Freeform
            || shape instanceof com.reader.office.fc.hslf.model.AutoShape
            || shape instanceof com.reader.office.fc.hslf.model.TextBox
            || shape instanceof com.reader.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.reader.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.reader.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.reader.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.reader.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect, 
            ...
            else if(shape instanceof com.reader.office.fc.hslf.model.AutoShape
                    || shape instanceof com.reader.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.reader.office.fc.hslf.model.Picture)
            {   
                com.reader.office.fc.hslf.model.Picture poiPic = (com.reader.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.reader.office.fc.hslf.model.Table)
        {
            com.reader.office.fc.hslf.model.Table poiTable = (com.reader.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.reader.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.reader.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.reader.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.reader.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.reader.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.reader.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        com.reader.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.reader.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.reader.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
