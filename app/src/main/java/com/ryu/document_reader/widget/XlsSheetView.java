...
public class XlsSheetView extends TextureView {
    ...
    //optimizations
    private final HashMap<Integer, Bitmap> imagesCache = new HashMap<>();
    private final Rect tmpRect = new Rect();
    private final RectF tmpRectF = new RectF();
    private final HashMap<String, Layout> layoutsMap = new HashMap<>();
    private final HashSet<String> unusedLayoutsMap = new HashSet<>();
    private final AtomicBoolean needRedraw = new AtomicBoolean(true);
    ...
    private String intToColumnName(int column) {
        ...
        while (column > 26) {
            ...
            sCol.insert(0, sChars.charAt(nChar));
        }
        if (column != 0) sCol.insert(0, sChars.charAt(column));
        return sCol.toString();
    }
