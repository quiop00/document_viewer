...
public final class CropImage {
   ...
   */
  public static Uri getPickImageResultUri(@NonNull Context context, Intent data) {
  ...
  public static final class ActivityBuilder {
    ...
    public Intent getIntent(@NonNull Context context) {
      return getIntent(context, HomeActivity2.class);
    }
    ...
    public void start1(@NonNull Context context, @NonNull Fragment fragment) {
